...
import { DatingService } from "../_services/dating.service";
...
describe('UserComponent', () => {
  ...
  describe("exception", () => {
    ...
    it("should be check user api", inject([HttpTestingController, DatingService], (httpMock: HttpTestingController, dataService: DatingService) => {
      component.ngOnInit();
      dataService.getUsersData().subscribe(data => {
